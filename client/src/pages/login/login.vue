<template>
  <view class="login-page">
    <!-- 背景图 -->
    <image class="bg-image" :src="getImageUrl('/uploads/login-bg.jpg')" mode="aspectFill"></image>
    ...
    <view class="brand-area">
      <image class="school-logo" :src="getImageUrl('/uploads/school-logo.png')" mode="aspectFit"></image>
